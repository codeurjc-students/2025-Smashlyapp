...
/**
 * PRUEBAS DE SISTEMA DEL CLIENTE - E2E Tests
 * 
 * Requisitos a verificar:
 * ✅ Se probará el interfaz de usuario
 * ✅ Se implementará al menos una prueba que verifique que los datos 
 *    de ejemplo de la entidad principal (palas) se muestran en la página principal
 */
...
public class FrontendSystemTest {
    ...
    void shouldLoadMainPageSuccessfully() {
        ...
        mainPage.navigateTo(frontendUrl);
