...
describe('RacketService - Integration Tests (with Real DB)', () => {
  ...
  describe('Real Database Integration', () => {
    (hasTestDB ? test : test.skip)('should connect to real database and fetch rackets', async () => {
    ...
    (hasTestDB ? test : test.skip)('should perform real filtering operations', async () => {
      console.log('🎛️  Testing real filter functionality...');
    ...
    (hasTestDB ? test : test.skip)('should get real statistics', async () => {
      ...
      try {
        ...
        console.log(`✅ Statistics: ${stats.total} total, ${stats.bestsellers} bestsellers, ${stats.onSale} on sale, ${stats.brands} brands`);
      } catch (error) {
    ...
    (hasTestDB ? test : test.skip)('should handle pagination correctly with real data', async () => {
      ...
      try {
        ...
        console.log(`✅ Pagination working: Page 1 has ${page1.data.length} items, Page 2 has ${page2.data.length} items`);
      } catch (error) {
